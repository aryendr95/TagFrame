...
public class IntentServiceOperations extends IntentService
    implements WebServiceHandler.UploadCallbacks {
  ...
  private void comment(String user_id, String event_id, String parent_id, String comment,
      int operation) {
  ...
  private void removefollow_unfollow(String touser_id, String fromuser_id, String type,
      int operation) {
