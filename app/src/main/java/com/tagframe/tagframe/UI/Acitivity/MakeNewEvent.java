    ...
    private Runnable mUpdateTimeTask = new Runnable() {
        public void run() {
            try {
                ...
                if (Utility.getScreenOrientation(MakeNewEvent.this) == ActivityInfo.SCREEN_ORIENTATION_PORTRAIT && !isLayoutSet) {
                    ...
                    if ((vidSurface.getHeight() <= height - Utility.dpToPx(150))) {
                        ...
                        RelativeLayout.LayoutParams layoutParams2 = new RelativeLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.FILL_PARENT);
            ...
            if (totalDurationn != 0) {
                ...
                Utility.updateseekbar(seekbar, mediaPlayer.getDuration(), MakeNewEvent.this,
                    framedata_map);
            }
                ...
                switch (item.getItemId()) {
                    ...
                    case R.id.medial_library_video:
                       /* new VideoPicker.Builder(MakeNewEvent.this).mode(VideoPicker.Mode.GALLERY)
                        ...
                        intent3.putExtra(com.veer.multiselect.Util.Constants.SELECT_TYPE,
                            Constants.PATH_VIDEO);
