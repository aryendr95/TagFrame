...
public class Profile extends Fragment {
    ...
    private View mview;
    private CircularImageView pro_user_iamge;
    private TextView pro_user_name, pro_user_realname, pro_description;
    ;
        ...
        protected void onPostExecute(String s) {
            ...
            if (status.equals("success")) {
                try {
                    ...
                    pro_user_name.setText(userinfo.getString("username"));
