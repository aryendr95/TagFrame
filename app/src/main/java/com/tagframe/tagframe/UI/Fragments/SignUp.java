...
public class SignUp extends Fragment {
                ...
                if (Networkstate.haveNetworkConnection(getActivity())) {
                    if (!uname.isEmpty() && !password.isEmpty() && !realname.isEmpty() && !email.isEmpty()) {
                        ...
                        if (Utility.isValidEmail(email)) {
                            ...
                            registerUser(uname, password, email, realname);
                        } else {
    ...
    private void registerUser(String username, final String password, String email, String realname) {
        ...
        progressDialog.show();
        Utility.getApiCaller().signUp(username, password, device_id, email, realname, appPrefs.getString(Utility.shp_user_Token), tz.getID())
                ...
                if (status.equals("success")) {
                    if (userinfo == null) {
                        ...
                        try {
                            ...
                            AppPrefs.putString(Utility.unread_notifications, "0");
