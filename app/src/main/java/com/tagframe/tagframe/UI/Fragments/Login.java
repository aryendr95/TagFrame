...
public class Login extends Fragment {
    ...
    public void loginUser(String username, final String password, String device_id) {
        ...
        progressDialog.show();
        Utility.getApiCaller().login(username, password, device_id, appPrefs.getString(Utility.shp_user_Token), tz.getID())
        ...
        protected String doInBackground(String... params) {
            try {
                ...
                if (status.equals("success")) {
                    ...
                    // Toast.makeText(getContext(),userinfo.toString(),Toast.LENGTH_SHORT).show();
                    save = params[2];
                }
            } catch (IOException q) {
                status = "url_error";
                ...
                if (status.equals("success")) {
                    if (userinfo == null) {
                        ...
                        try {
                            ...
                            AppPrefs.putString(Utility.unread_notifications, userinfo.getString(Utility.unread_notifications));
