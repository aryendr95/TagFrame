...
public class MyNotificationManager {
    ...
    public void displayNotification(String title, String body) {
        NotificationCompat.Builder mBuilder = new NotificationCompat.Builder(mCtx).setSmallIcon(R.drawable.logout)
         ...
         * */
        Intent resultIntent = new Intent(mCtx, TagStream.class);
