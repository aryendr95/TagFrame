...
import static com.tagframe.tagframe.UI.Acitivity.Modules.strfollower;
...
public class AppPrefs {
    ...
    public ArrayList<Event_Model> gettagstreamlist(String listname) {
        ...
        Type type = new TypeToken<ArrayList<Event_Model>>() {
        }.getType();
    ...
    public ArrayList<SingleEventModel> getsingleeventlist() {
        ...
        Type type = new TypeToken<ArrayList<SingleEventModel>>() {
        }.getType();
    ...
    public ArrayList<User_Frames_model> getuser_frames() {
        ...
        Type type = new TypeToken<ArrayList<User_Frames_model>>() {
        }.getType();
    ...
    public ArrayList<FollowModel> getuser_following() {
        ...
        Type type = new TypeToken<ArrayList<FollowModel>>() {
        }.getType();
    ...
    public void putuserfollowing(ArrayList<FollowModel> arrayList) {
        ...
        strfollower = String.valueOf(arrayList.size());
        editor.apply();
    }
