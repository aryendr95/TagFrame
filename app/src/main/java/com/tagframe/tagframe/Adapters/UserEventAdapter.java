...
public class UserEventAdapter extends BaseAdapter
{
    ...
    Context ctx;
    ArrayList<UserEventsModel> tagStream_models;
    LayoutInflater inflater;
    listops user_data;

    public UserEventAdapter(Context ctx,ArrayList<UserEventsModel> tagStream_models)
    {
        this.ctx=ctx;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final UserEventsModel tagStream=tagStream_models.get(position);
