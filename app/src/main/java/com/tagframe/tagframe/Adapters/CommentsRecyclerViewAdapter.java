...
public class CommentsRecyclerViewAdapter extends RecyclerView.Adapter<CommentsRecyclerViewAdapter.MyViewHolder> {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View convertView) {
            super(convertView);
            img_userpic = (CircleImageView) convertView.findViewById(R.id.img_commentlist_pic);
            ...
            img_send_imageview =
                    (ImageButton) convertView.findViewById(R.id.img_commentlist_send_comment);
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_list_comments, parent, false);
    ...
    public void onBindViewHolder(final MyViewHolder mViewHolder, int position) {
        ...
        mViewHolder.list_nested_comments.setAdapter(
                new NestedCommentsAdapter(context, comment.getReplyCommentArrayList()));
        ...
        if (comment.isViewallreply()) {
            ...
            mViewHolder.tv_view_allreply.setText(
                    "View all " + comment.getReplyCommentArrayList().size() + " replies");
        }
        ...
        mViewHolder.img_send_imageview.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!str_comment.isEmpty()) {
                    Broadcastresults mReceiver = null;
                    if (context instanceof Modules) {
                        mReceiver = ((Modules) context).register_reviever();
                    } else if (context instanceof WatchEventActivity) {
                        mReceiver = ((WatchEventActivity) context).register_reviever();
                    }
