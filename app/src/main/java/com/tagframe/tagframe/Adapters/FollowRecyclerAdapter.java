...
public class FollowRecyclerAdapter extends RecyclerView.Adapter<FollowRecyclerAdapter.MyViewHolder> {
                    ...
                    public void onClick(View v) {
                       ...
                       /* mReceiver=((Modules)ctx).register_reviever();
                        ...
                        dialog.findViewById(R.id.dia_rem_yesbtn).setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                followModelArrayList.remove(position);
                                //userinfo.putuserfollowers(followModelArrayList);//
//                                ((Modules) ctx).finish();
//                                ((Modules)ctx).startActivity(((Modules) ctx).getIntent());
