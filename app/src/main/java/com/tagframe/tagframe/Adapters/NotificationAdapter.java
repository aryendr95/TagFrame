...
public class NotificationAdapter extends RecyclerView.Adapter<NotificationAdapter.MyViewHolder>{
  ...
  @Override public void onBindViewHolder(final MyViewHolder holder, final int position) {
    ...
    final int user_type =
        Utility.getUser_Type(ListModel.getUser_id(), appPrefs.getString(Utility.user_id));
  ...
  private void loadEvent(ApiInterface apiInterface, final String id) {
    ...
    apiInterface.getEventDetails(id).enqueue(new Callback<EventDetailResponseModel>() {
      @Override public void onResponse(Call<EventDetailResponseModel> call,
          Response<EventDetailResponseModel> response) {
        dialog.dismiss();
        if (response.body().getStatus().equals(Utility.success_response)) {
          ...
          intent.putParcelableArrayListExtra("framelist",
              event_model.getFrameList_modelArrayList());
      ...
      @Override public void onFailure(Call<EventDetailResponseModel> call, Throwable t) {
